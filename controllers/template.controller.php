...
class TemplateController{
	...
	static public function sendEmail($subject, $email, $title, $message, $link, $buzon){
		...
		$mail->Host       = 'smtp.hostinger.com';         // Servidor SMTP de tu proveedor de correos
		...
		$mail->setFrom("buzon@analitik360bp.com", $buzon);
		...
		$mail->msgHTML('
			<div style="width:100%; background:#eee; position:relative; font-family:sans-serif; padding-top:40px; padding-bottom: 40px;">
				<div style="position:relative; margin:auto; width:600px; background:white; padding:20px">
					<center>
						<img src="https://smartbook.analitik360bp.com/views/assets/img/logo_analitik_360.png"  alt="Logo" style="padding:20px; width:30%">
