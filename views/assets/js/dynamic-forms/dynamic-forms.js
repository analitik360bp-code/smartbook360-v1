...
/*=============================================
Gestionar el JSON de Ingredientes
=============================================*/

$(document).on("change",".changeIngredient",function(){

	var sku =  $(this).val().split("^")[1];
	var medida =  $(this).val().split("^")[2];
	var position = $(this).parent().parent().parent().parent().parent().attr("position");

	$("."+position+"valueJson.sku").val(sku);
	$("."+position+"valueJson.medida").val(medida);
