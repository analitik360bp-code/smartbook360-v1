    ...
    <div class="container-fluid py-3 p-lg-4">
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-4 mb-3">
                <div class="card rounded reservation-card">
                    <div
                        class="card-header reservation-header rounded-top d-flex justify-content-between align-items-center">
                    ...
                    <div
                        ...
                        <select id="filterTable" class="form-select form-select-sm w-auto">
                            ...
                            <?php foreach ($tables as $key => $value): ?>
                                <option value="<?php echo urldecode($value->title_table) ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control reservation-input" id="client_book"
                                        name="client_book" required>
                                </div>

                                <div class="mb-3">
                                    <label for="customerPhone" class="form-label">Teléfono *</label>
                                    <input type="tel" class="form-control reservation-input" id="phone_book"
                                        name="phone_book" required>
                                </div>

                                <div class="mb-3">
                                    <label for="customerEmail" class="form-label">Email</label>
                                    <input type="email" class="form-control reservation-input" id="email_book"
                                        name="email_book">
                                </div>
                            ...
                            <div class="col-12 col-md-6 mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select reservation-input" id="id_table_book" name="id_table_book"
                                        required>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control reservation-input" id="description_book"
                                    name="description_book" rows="3"
                                    placeholder="Alergias, celebraciones, preferencias especiales..."></textarea>
                            </div>
...
<?php else:
    include "views/pages/welcome/welcome.php" ?>
