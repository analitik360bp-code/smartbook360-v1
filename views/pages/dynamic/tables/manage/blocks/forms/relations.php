<?php if ($module->columns[$i]->type_column == "relations"): ?>
	...
	<?php if ($module->columns[$i]->matrix_column != null): ?>
		<?php 
			if($module->columns[$i]->matrix_column == "offices" and $_SESSION["admin"]->rol_admin != "superadmin"){
				$url = $module->columns[$i]->matrix_column."?linkTo=id_office&equalTo=".$_SESSION["admin"]->id_office;
			}else{
