...
<head>
	...
	<link rel="icon" href="https://smartbook.analitik360bp.com/views/assets/img/Logo_.png" sizes="32x32" type="image/png">
	...
	<?php if (!empty($admin)): ?>
		...
		<style>
			...
			<?php if ($admin->font_admin != null): ?>
				...
				body {
					font-family:
						<?php echo str_replace("+", " ", explode("=", explode(":", explode("?", $admin->font_admin)[1])[0])[1]) ?>
	...
	<link rel="stylesheet" href="/views/assets/css/confirmacion/confirmacion.css">
...
<body>
	...
	if (!isset($_SESSION["admin"])) {
		...
		if ($admin == null) {
			...
			$url_path_ = strtok($_SERVER['REQUEST_URI'], '?');
			$confirm = explode("/", $url_path_);

			include "pages/confirmacion/modules/header.php";
			if ($url_path_ == "/confirmacion") {

				include "pages/confirmacion/confirmacion.php";

			} elseif (isset($confirm[2]) && $confirm[2] == "confirm") {

				include "pages/confirmacion/confim.php";
		...
		<div class="d-flex backDashboard" id="wrapper">
			...
			<div id="page-content-wrapper">
				...
				<?php if (!empty($routesArray[0])): ?>
					...
					<?php else: ?>
						...
						<?php if (
							...
							strtolower(json_decode(urldecode($_SESSION["admin"]->permissions_admin), true)[$routesArray[0]]) == "on"
						): ?>
				...
				<?php else: ?>
					...
					<?php if ($_SESSION["admin"]->rol_admin == "superadmin" || $_SESSION["admin"]->rol_admin == "admin" || $_SESSION["admin"]->rol_admin == "gerente"): ?>
	...
	===============================================-->
		...
		<script src="/views/assets/js/cost-control/cost-control.js"></script>
		<script src="/views/assets/js/date-suscripcion/suscripcion.js"></script>
